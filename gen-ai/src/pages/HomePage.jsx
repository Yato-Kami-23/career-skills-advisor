...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col bg-light-yellow text-dark-indigo dark:bg-dark-indigo dark:text-light-yellow transition-colors duration-500">
      {/* Navbar */}
      <Navbar />
      ...
      <main className="flex-grow p-8">
        ...
        <section className="text-center mb-12">
          ...
          <div className="mt-6 flex justify-center">
            <div className="h-64 w-96 bg-light-fairy dark:bg-dark-peach rounded-lg flex items-center justify-center shadow-lg">
        ...
        <section className="bg-light-crystal dark:bg-dark-plum rounded-xl shadow-lg p-8 max-w-4xl mx-auto text-center">
          ...
          <button className="bg-light-honey dark:bg-dark-orchid text-dark-indigo dark:text-light-yellow px-6 py-2 rounded-full shadow hover:opacity-90 transition">
            Try the Chatbot
          </button>
        </section>
      </main>
